...
UsingCppType(ImGuiWindow);

UsingCppType(ImGuiViewportP);
...
DeclOverload(ImGui_Selectable, bool (*)
             (const char*,
	             bool,
	             ImGuiSelectableFlags,
	             const ImVec2&),
             &ImGui::Selectable, false, 0, ImVec2(0,0));
...
DeclOverload(ImGui_Selectable, bool (*)
             (const char*,
	             ...
	             ImGuiSelectableFlags,
	             const ImVec2&
             ), &ImGui::Selectable, 0, ImVec2(0,0));

DeclOverloads(ImDrawList_AddText);

DeclOverload(ImDrawList_AddText, void(ImDrawList::*)
             (const ImVec2&,
	             ImU32,
	             const char*,
	             const char*
...
DeclOverload(ImDrawList_AddText, void(ImDrawList::*)(
	             ...
	             float,
	             const ImVec4*
             ), &ImDrawList::AddText, nullptr, 0.0f, nullptr);
...
struct AutoRegisterForDearImGui
{
	...
	{
		// define no param
#define DEFN(T) puerts::DefineClass<T>()
		// define with param
#define DEF(T, V) puerts::DefineClass<T>(V)

		DEFN(ImGuiContext).Register();
		DEFN(ImDrawListSharedData).Register();
		DEFN(ImFontConfig).Register();
		DEFN(ImFontGlyph).Register();
		DEFN(ImDrawListSplitter).Register();
		DEFN(ImDrawVert).Register();
		DEFN(ImGuiInputTextCallbackData)
		...
		DEFN(ImGuiWindow)
			.Property("Flags", MakeProperty(&ImGuiWindow::Flags))
			.Property("ID", MakeProperty(&ImGuiWindow::ID))
			.Property("ViewportId", MakeProperty(&ImGuiWindow::ViewportId))
			.Property("ViewportPos", MakeProperty(&ImGuiWindow::ViewportPos))
			.Property("Viewport", MakeProperty(&ImGuiWindow::Viewport))
			.Property("Name", MakeProperty(&ImGuiWindow::Name))
			.Property("NameBufLen", MakeProperty(&ImGuiWindow::NameBufLen))
			.Property("MoveId", MakeProperty(&ImGuiWindow::MoveId))
			.Property("Scroll", MakeProperty(&ImGuiWindow::Scroll))
			.Property("ScrollTarget", MakeProperty(&ImGuiWindow::ScrollTarget))
			.Property("ScrollTargetCenterRatio", MakeProperty(&ImGuiWindow::ScrollTargetCenterRatio))
			.Property("ScrollTargetEdgeSnapDist", MakeProperty(&ImGuiWindow::ScrollTargetEdgeSnapDist))
			.Property("ScrollbarSizes", MakeProperty(&ImGuiWindow::ScrollbarSizes))
			.Register();
		...
		DEFN(ImDrawList)
			...
			.Method("AddText", CombineOverloads(
				        ...
				        SelectOverload(ImDrawList_AddText, void(ImDrawList::*)(ImFont*, float, const ImVec2&, ImU32, const char*, const char*, float, const ImVec4*))
			        ))
			.Register();
		...
		DEFN(DearImGui)
			...
			.Function("GetIO", CombineOverloads(
				          MakeOverload(ImGuiIO& (*)(), &ImGui::GetIO),
				          MakeOverload(ImGuiIO& (*)(ImGuiContext*), &ImGui::GetIO)
			          ))
			...
			.Function("ShowDemoWindow", MakeFunctionWithScriptTypePtr(&ImGui::ShowDemoWindow, static_cast<bool*>(nullptr)))
			.Function("ShowAboutWindow", MakeFunctionWithScriptTypePtr(&ImGui::ShowAboutWindow, static_cast<bool*>(nullptr)))
			.Function("ShowMetricsWindow", MakeFunctionWithScriptTypePtr(&ImGui::ShowMetricsWindow, static_cast<bool*>(nullptr)))
			...
			.Function("Begin", MakeFunctionWithScriptTypePtr(&ImGui::Begin, nullptr, static_cast<bool*>(nullptr), 0))
			.Function("End", MakeFunction(&ImGui::End))
			.Function("BeginChild", CombineOverloads(
				          MakeOverload(bool (*)(const char*, const ImVec2&, ImGuiChildFlags, ImGuiWindowFlags), &ImGui::BeginChild),
				          MakeOverload(bool (*)(ImGuiID, const ImVec2&, ImGuiChildFlags, ImGuiWindowFlags), &ImGui::BeginChild)
			          ))
			...
			// .Function("GetWindowContentRegionWidth", MakeFunction(&ImGui::GetWindowContentRegionWidth)) del
			...
			.Function("SetScrollX", CombineOverloads(
				          MakeOverload(void (*)(float), &ImGui::SetScrollX),
				          MakeOverload(void (*)(ImGuiWindow*, float), &ImGui::SetScrollX)
			          ))
			// .Function("SetScrollY", MakeFunction(&ImGui::SetScrollY))
			.Function("SetScrollY", CombineOverloads(
				          MakeOverload(void (*)(float), &ImGui::SetScrollY),
				          MakeOverload(void (*)(ImGuiWindow*, float), &ImGui::SetScrollY)
			          ))
			...
			.Function("SetScrollFromPosX", CombineOverloads(
				          MakeOverload(void (*)(ImGuiWindow*, float, float), &ImGui::SetScrollFromPosX),
				          MakeOverload(void (*)(float, float), &ImGui::SetScrollFromPosX)
			          ))
			...
			.Function("GetColorU32", CombineOverloads(
				          ...
				          MakeOverload(ImU32 (*)(ImU32, float), &ImGui::GetColorU32)
			          ))
			...
			.Function("Image", CombineOverloads(
				          MakeOverload(void (*)(ImTextureID, const ImVec2&, const ImVec2&, const ImVec2&), &ImGui::Image),
				          MakeOverload(void (*)(ImTextureID, const ImVec2&, const ImVec2&, const ImVec2&, const ImVec4&, const ImVec4&), &ImGui::Image)))
			.Function("ImageButton", MakeFunction(&ImGui::ImageButton, ImVec2(0,0), ImVec2(1,1), ImVec2(1, 1), ImVec4(0,0,0,0), ImVec4(1,1,1,1)))
			...
			.Function("BeginPopupModal", MakeFunctionWithScriptTypePtr(&ImGui::BeginPopupModal, nullptr, static_cast<bool*>(nullptr), 0))
			...
			.Function("IsPopupOpen", CombineOverloads(
				          MakeOverload(bool (*)(const char*, ImGuiPopupFlags), &ImGui::IsPopupOpen),
				          MakeOverload(bool (*)(ImGuiID, ImGuiPopupFlags), &ImGui::IsPopupOpen)
			          ))
			...
			.Function("BeginTabItem", MakeFunctionWithScriptTypePtr(&ImGui::BeginTabItem, nullptr, static_cast<bool*>(nullptr), 0))
			...
			// .Function("CalcListClipping", MakeFunction(&ImGui::CalcListClipping)) del
			...
			// .Function("GetKeyIndex", MakeFunction(&ImGui::GetKeyIndex)) del
			// .Function("IsKeyDown", MakeFunction(&ImGui::IsKeyDown))
			.Function("IsKeyDown", CombineOverloads(
				          MakeOverload(bool (*)(ImGuiKey, ImGuiID), &ImGui::IsKeyDown),
				          MakeOverload(bool (*)(ImGuiKey), &ImGui::IsKeyDown)
			          ))
			// .Function("IsKeyPressed", MakeFunction(&ImGui::IsKeyPressed, true))
			.Function("IsKeyPressed", CombineOverloads(
				          MakeOverload(bool (*)(ImGuiKey, bool), &ImGui::IsKeyPressed),
				          MakeOverload(bool (*)(ImGuiKey, ImGuiInputFlags, ImGuiID), &ImGui::IsKeyPressed)
			          ))
			// .Function("IsKeyReleased", MakeFunction(&ImGui::IsKeyReleased))
			.Function("IsKeyReleased", CombineOverloads(
				          MakeOverload(bool (*)(ImGuiKey, ImGuiID), &ImGui::IsKeyReleased),
				          MakeOverload(bool (*)(ImGuiKey), &ImGui::IsKeyReleased)
			          ))
			.Function("GetKeyPressedAmount", MakeFunction(&ImGui::GetKeyPressedAmount))
			// .Function("IsMouseDown", MakeFunction(&ImGui::IsMouseDown))
			.Function("IsMouseDown", CombineOverloads(
				          MakeOverload(bool (*)(ImGuiMouseButton, ImGuiID), &ImGui::IsMouseDown),
				          MakeOverload(bool (*)(ImGuiMouseButton), &ImGui::IsMouseDown)
			          ))
			.Function("IsAnyMouseDown", MakeFunction(&ImGui::IsAnyMouseDown))
			// .Function("IsMouseClicked", MakeFunction(&ImGui::IsMouseClicked, false))
			.Function("IsMouseClicked", CombineOverloads(
				          MakeOverload(bool (*)(ImGuiMouseButton, ImGuiInputFlags, ImGuiID), &ImGui::IsMouseClicked),
				          MakeOverload(bool (*)(ImGuiMouseButton, bool), &ImGui::IsMouseClicked)
			          ))
			// .Function("IsMouseDoubleClicked", MakeFunction(&ImGui::IsMouseDoubleClicked))
			.Function("IsMouseDoubleClicked", CombineOverloads(
				          MakeOverload(bool (*)(ImGuiMouseButton, ImGuiID), &ImGui::IsMouseDoubleClicked),
				          MakeOverload(bool (*)(ImGuiMouseButton), &ImGui::IsMouseDoubleClicked)
			          ))
			// .Function("IsMouseReleased", MakeFunction(&ImGui::IsMouseReleased))
			.Function("IsMouseReleased", CombineOverloads(
				          MakeOverload(bool (*)(ImGuiMouseButton, ImGuiID), &ImGui::IsMouseReleased),
				          MakeOverload(bool (*)(ImGuiMouseButton), &ImGui::IsMouseReleased)
			          ))
			...
			// .Function("CaptureKeyboardFromApp", MakeFunction(&ImGui::CaptureKeyboardFromApp, true)) del
			// .Function("CaptureMouseFromApp", MakeFunction(&ImGui::CaptureMouseFromApp, true)) del
			...
			// .Function("SaveIniSettingsToMemory", MakeFunction(&ImGui::SaveIniSettingsToMemory, nullptr)) TODO : 懒得搞
